...
// RunCommand returns the "run" cobra command.
...
// CollectScenarioFiles collects .md scenario files from a path (file or directory).
...
// HasTag returns true if scenarioTags contains the given tag.
...
// MatchesTags returns true if any filterTag is present in scenarioTags.
